...
function buildConfig(yamlConfig, overrides, logger) {
    ...
    let config = {
        ...
        maxFiles: typeof inputMaxFiles === "number"
            ? inputMaxFiles
    ...
    if (yamlConfig) {
        ...
        if (yamlConfig.post_no_findings !== undefined &&
        ...
        if (yamlConfig.max_files !== undefined &&
        ...
        if (yamlConfig.entropy) {
            config.entropy = {
                ...
                ignoreBase64Like: yamlConfig.entropy.ignore_base64_like ??
