...
async function cmdInit(): Promise<void> {
  ...
  try {
    ...
    console.error("⚠️  Failed to install git hooks:", (e as Error).message);
    console.log("   You can manually install them later with: keysentinel install");
  }

  console.log("\n🎉 KeySentinel is now configured and ready!");
  console.log("\nTest it:");
  console.log("  1. Create a file with a fake secret");
  console.log("  2. Stage it: git add <file>");
  console.log("  3. Try to commit: git commit -m 'test'");
  console.log("   → The commit should be blocked if a secret is detected");
  console.log("");
}
